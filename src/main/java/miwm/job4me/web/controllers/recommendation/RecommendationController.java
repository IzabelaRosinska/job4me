...
public class RecommendationController {
    ...
    @GetMapping("employee/job-offers/list-display/job-fairs/{jobFairId}/recommendation")
    ...
    @PostMapping("employee/job-offers/list-display/job-fairs/{jobFairId}/recommendation/filter")
