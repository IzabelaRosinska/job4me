...
public class CorsConfig extends WebMvcConfigurerAdapter {
    ...
    public void addCorsMappings(CorsRegistry registry) {
        registry.addMapping("/**")
                .allowedOrigins(FRONT_BRANCH_HOST_AZURE, FRONT_HOST_AZURE, FRONT_HOST, LINKEDIN_HOST, STRIPE_HOST, "https://mango-moss-0c13e2b03-57.westeurope.3.azurestaticapps.net")
