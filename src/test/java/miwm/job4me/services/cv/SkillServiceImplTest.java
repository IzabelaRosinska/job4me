...
class SkillServiceImplTest {
    ...
    public void testSaveThrowExceptionNull() {
        Mockito.doThrow(new IllegalArgumentException(ExceptionMessages.nullArgument(entityName))).when(skillValidator).validate(null);
    ...
    public void testSaveThrowExceptionDescriptionTooLong() {
        ...
        Mockito.doThrow(new IllegalArgumentException(ExceptionMessages.textTooLong(entityName, "description", maxDescriptionLength))).when(skillValidator).validate(skill1);
